            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-4">
                        <h3 class="text-lg font-semibold">Laporan Bulan {{ $startDate->format('F Y') }}</h3>
                    ...
                    <!-- Daily Breakdown -->
                    <h4 class="text-md font-semibold mb-3">Rincian per Hari</h4>
                    ...
                    <!-- Transaction Details -->
                    <h4 class="text-md font-semibold mb-3">Detail Transaksi</h4>
