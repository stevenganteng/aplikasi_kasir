                ...
                <div class="p-6">
                    <form action="{{ route('admin.tariffs.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" name="description" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 rounded-md shadow-sm">{{ old('description') }}</textarea>
